...
public class Books implements Parcelable
{
    ...
    public final static Parcelable.Creator<Books> CREATOR = new Creator<Books>() {
        ...
        public Books createFromParcel(Parcel in) {
            ...
            in.readList(instance.breadcrumbs, (in.shpt.models.products.book.Breadcrumb.class.getClassLoader()));
            ...
            in.readList(instance.categories, (in.shpt.models.products.book.Category.class.getClassLoader()));
            in.readList(instance.products, (in.shpt.models.products.book.Product.class.getClassLoader()));
            in.readList(instance.sorts, (in.shpt.models.products.book.Sort.class.getClassLoader()));
            in.readList(instance.limits, (in.shpt.models.products.book.Limit.class.getClassLoader()));
