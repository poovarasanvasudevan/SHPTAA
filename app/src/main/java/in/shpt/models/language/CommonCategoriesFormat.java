...
public class CommonCategoriesFormat implements Parcelable
{
    ...
    public final static Parcelable.Creator<CommonCategoriesFormat> CREATOR = new Creator<CommonCategoriesFormat>() {


        @SuppressWarnings({
            "unchecked"
        })
        public CommonCategoriesFormat createFromParcel(Parcel in) {
            CommonCategoriesFormat instance = new CommonCategoriesFormat();
        ...
        public CommonCategoriesFormat[] newArray(int size) {
            return (new CommonCategoriesFormat[size]);
        }
